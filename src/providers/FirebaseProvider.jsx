 ...
 * @property {import('firebase/app').FirebaseApp} myApp 
 * @property {import('firebase/auth').Auth} myAuth 
 * @property {import('firebase/firestore').Firestore} myFS 
 * @property {import('firebase/storage').FirebaseStorage} myStorage
 * @property {boolean} usingEmulators 
 * @property {object} emulatorsConfig 
 *
